...
Argument METHOD-STRING ..."
  (let ((parameters (mapcar (lambda (x) (string-trim (replace-regexp-in-string (cdr (assoc "method-argument" magik-regexp)) "" x))) (split-string method-string "(\\|)\\|,")))
    ...
    (magik--write-method-type-doc missing-parameters starting-point documentation-found write-return (length parameters))))
...
(defun magik--write-method-type-doc (missing-parameters starting-point documentation-found write-return parameters-count)
